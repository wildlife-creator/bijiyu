...
export const LEGAL_ARTICLES: LegalArticle[] = [
  ...
  {
    title: "支払方法",
    blocks: [{ type: "paragraph", text: "クレジットカード決済" }],
  },
  {
    title: "支払時期",
    blocks: [
      {
        type: "paragraph",
        text: "料金の発生しない無料プランをご利用の場合、お支払いは発生しません。有料プランのうちサブスクリプション（月額課金制）をご契約の場合、クレジットカードにより初回お申し込み時に課金され、以後は毎月、契約更新日に自動的に課金されます。買い切り（都度課金）のサービスをご購入の場合、ご注文と同時にクレジットカードにより決済されます。",
      },
    ],
  },
  {
