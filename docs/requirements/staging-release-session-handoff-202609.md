...
- ステージング指摘 9 件（No.33/8/1・24/21/22/35・37/40/確認-3ab）は 2026-09-08 に全件実装済み（`staging-check-fix-plan-202609.md` 末尾参照）
...
- 修正依頼メモ: `docs/requirements/video-display-size-request-202609.md`（対応済みだが経緯の記録として残す）
