...
- [x] 10.2 (P) CLI-020 発注者情報詳細画面
  ...
  - 表示項目: 社名・氏名（`display_name`）、住所、画像、募集職種、募集エリア、従業員規模、求める働き方、言語、メッセージ、評判
...
- [x] 17. CLI-016〜025 + AUTH-008 のユーザーストーリーを Playwright で網羅する

- [x] 17.1 (P) スカウトテンプレート CRUD の通しフロー
...
- [x] 17.2 (P) 発注者プロフィール編集と setup モード
...
- [x] 17.3.5 招待フローのエッジケース / 権限外アクセス検証（17.3 の下位タスク）
