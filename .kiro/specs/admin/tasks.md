...
- [ ] 7. (P) ADM-022 募集現場詳細（admin 閲覧専用）を実装する
...
- [ ] 10. 応募履歴管理（ADM-013 / 014）
- [ ] 10.1 (P) ADM-013 応募履歴一覧を実装する
...
- [ ] 10.2 (P) ADM-014 応募履歴詳細と発注取り消しを実装する
...
- [ ] 11. 問い合わせ閲覧 3ペア（ADM-016〜021）
- [ ] 11.1 (P) ADM-016/017 お問い合わせ一覧・詳細を実装する
...
- [ ] 11.2 (P) ADM-018/019 トラブル報告一覧・詳細を実装する
  - デザインカンプなし（admin 共通スタイルに合わせる）
...
- [ ] 11.3 (P) ADM-020/021 求人問い合わせ一覧・詳細を実装する
  - デザインカンプなし（admin 共通スタイルに合わせる）
